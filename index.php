...
<head>
	...
	<link rel="stylesheet" href="_css/style.bootstrap.css">
	<link rel="stylesheet" href="_css/style.main.css">
	<link rel="stylesheet" href="_css/style.floater.css">
...
<body>
	...
	if(isset($_REQUEST['register'])){
		require_once($_SERVER['DOCUMENT_ROOT'].'/fragments/register.php');
	}
	else if(isset($_SESSION['user'])){
		require_once($_SERVER['DOCUMENT_ROOT'].'/fragments/filelist.php');
	}
	else{
		require_once($_SERVER['DOCUMENT_ROOT'].'/fragments/loginform.php');
	}
